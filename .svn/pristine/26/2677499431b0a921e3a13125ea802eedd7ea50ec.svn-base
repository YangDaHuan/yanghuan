...
<div data-options="region:'center',title:'票卡上交'" style="padding:20px;background:#eee;">
<form id="dataForm" >   
    ...
    <table>
		...
		<caption align="top" style="font-size:24px;color:#006600;">票卡上交单</caption> 			
    	<tr><td>&nbsp</td>   </tr>
		...
		<tr>
		<td>   
        <label for="applyContacts">申请人:</label>   
        </td><td>
			<input name="applyContacts" class="easyui-textbox" style="width:150px" value="<%=sys_username %>" readonly> 
       </td>
       <td>   
        <label for="applyPhone">申请人电话:</label>   
        </td><td>
