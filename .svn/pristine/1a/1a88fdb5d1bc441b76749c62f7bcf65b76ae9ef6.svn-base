...
function auditStateFormatter (value, row, index) {
	var auditStates=[{stateId:1,stateName:'已提交'},{stateId:2,stateName:'审核中'},{stateId:3,stateName:'审核通过'},{stateId:4,stateName:'审核未通过'},{stateId:5,stateName:'已入库'},{stateId:4,stateName:'已出库'}];
...
<div id="dataTabelToolBar" style="height: auto">
    ...
    <thead>   
        <tr>
      			...
      			<th data-options="field:'applyType',width:70,formatter:applyTypeFormatter" >申请类型</th>  
      			<th data-options="field:'applyOrg',width:100,formatter:orgFormatter,align:'center'" >申请部门</th>
      			<th data-options="field:'applyContacts',width:60" >申请人</th>  
      			...
      			<th data-options="field:'auditingState',width:80,formatter:auditStateFormatter" >审核状态</th> 
