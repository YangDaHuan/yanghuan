...
<body topmargin=0 leftmargin=0 rightmargin=0 bottomMargin=0 style="background:transparent;" onload="try{parent.hideLoading()}catch(e){}">
...
<%
	...
	//以下代码是检测这个报表是否有相应的参数模板 <img src="../raqsoft/images/loading.gif">
	String paramFile = report.substring(0,iTmp)+"_arg.rpx";
	boolean hasParam = ReportUtils.isReportFileExist( paramFile );
%>
<div id=mengban style="background-color:transparent;position:absolute;z-index:999;width:100%;height:100%">
	<table width=100% height=100%>
		<tr><td width=100% style="text-align:center;vertical-align:middle"><img src="../raqsoft/images/loading.gif"><br>正在加载报表......</td></tr>
	</table>
</div>
<div id=reportArea class="easyui-layout" data-options="fit:true" style="display:none;width:100%;height:100%;background:transparent;">
	<%	//如果参数模板存在，则显示参数模板
	if( hasParam ) {
	%>
	...
	<% }%>
	<div id=reportContainer data-options="region:'center',border:false" style="text-align:center;background:transparent;">
