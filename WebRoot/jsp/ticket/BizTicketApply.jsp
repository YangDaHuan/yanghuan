...
function doSearch(){
	...
	$.post("ticket/findByAttrBizTicketApply.zb",formdata,function(data){
			if(data.success){
...
function saveData(){
	...
	$.post("ticket/saveBizTicketApply.zb",formdata,function(data){
			if(data.success){
...
function deleteRows(){
	...
	if(rows.length<1){
		...
		var obj={};
        		...
        		var applyId=new Array();
				for(var i=0;i<rows.length;i++){
					applyId.push(rows[i].applyId);
				}
				obj.applyId=applyId;
		
		
		
		$.post("ticket/deleteBizTicketApply.zb",obj,function(data){
			if(data.success){
...
<div id="dataTabelToolBar" style="height: auto">
			...
			<form id="queryForm">
					...
					:<input name="applyId" class="easyui-textbox" style="width:100px"> 
					:<input name="applyType" class="easyui-textbox" style="width:100px"> 
					:<input name="applyOrg" class="easyui-textbox" style="width:100px"> 
					:<input name="applyContacts" class="easyui-textbox" style="width:100px"> 
					:<input name="applyPhone" class="easyui-textbox" style="width:100px"> 
					:<input name="toOrg" class="easyui-textbox" style="width:100px"> 
        			:<input name="applyDate" class="easyui-datebox" style="width:100px"> 
					:<input name="auditingState" class="easyui-textbox" style="width:100px"> 
					:<input name="auditingOrg" class="easyui-textbox" style="width:100px"> 
					:<input name="auditingUsr" class="easyui-textbox" style="width:100px"> 
    ...
    <thead>   
        <tr>
      			...
      			<th data-options="field:'applyType',width:100" ></th>  
      			<th data-options="field:'applyOrg',width:100" ></th>  
      			<th data-options="field:'applyContacts',width:100" ></th>  
      			<th data-options="field:'applyPhone',width:100" ></th>  
      			<th data-options="field:'toOrg',width:100" ></th>  
      			<th data-options="field:'applyDate',width:100" ></th>  
      			<th data-options="field:'auditingState',width:100" ></th>  
      			<th data-options="field:'auditingOrg',width:100" ></th>  
      			<th data-options="field:'auditingUsr',width:100" ></th>  
