...
function auditStateFormatter (value, row, index) {
	var auditStates=[{stateId:1,stateName:'已提交'},
	                 {stateId:2,stateName:'审核中'},
	                 {stateId:3,stateName:'审核通过'},
	                 {stateId:4,stateName:'审核未通过'},
	                 {stateId:5,stateName:'审核通过'},
	                 {stateId:6,stateName:'审核通过'},
	                 {stateId:7,stateName:'审核通过'}];
...
<div id="dataTabelToolBar" style="height: auto">
			...
			<form id="queryForm">
					...
					申请类型:<select class="easyui-combobox" name="applyType" style="width:80px;">   
    			<option value="">全部</option>   
    			<option value="1">申领</option>   
    			<option value="2">上交</option>   
			</select> 
					申请部门:<input id="applyOrg" class="easyui-combotree" name="applyOrg"
								style="width: 150px;"
								data-options="
								 value:'<%=sys_orgid %>',
					...
					<input id="toOrg" class="easyui-combotree" name="toOrg"
						...
						">
        			申请日期:<input name="applyDate" class="easyui-datebox" style="width:100px"> 
					<!-- 
						审核状态:
					<select class="easyui-combobox" name="auditingState" style="width:100px;">   
		    			<option value="">全部</option>   
    ...
    <thead >   
        <tr>
      			...
      			<th data-options="field:'applyOrg',width:80,formatter:orgFormatter,align:'center'" >申请部门</th>  
      			...
      			<th data-options="field:'toOrg',width:80,formatter:orgFormatter,align:'center'" >目标部门</th>  
      			<th data-options="field:'applyDate',width:80,formatter:dateFormatter,align:'center'" >申请日期</th>  
      			<th data-options="field:'auditingState',width:60,formatter:auditStateFormatter,align:'center'" >审核状态</th>  
      			<th data-options="field:'auditingOrg',width:80,formatter:orgFormatter,align:'center'" >审核部门</th>  
