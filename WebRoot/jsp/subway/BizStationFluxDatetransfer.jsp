...
function doSearch(){
	...
	$.post("subway/findByAttrBizStationFluxDatetransfer.zb",formdata,function(data){
			if(data.success){
...
function saveData(){
	...
	$.post("subway/saveBizStationFluxDatetransfer.zb",formdata,function(data){
			if(data.success){
...
function deleteRows(){
	...
	if(rows.length<1){
		...
		$.post("subway/deleteBizStationFluxDatetransfer.zb",obj,function(data){
			if(data.success){
...
<div id="dataTabelToolBar" style="height: auto">
			...
			<form id="queryForm">
					...
					节假日名称:<input name="datetransferName" class="easyui-textbox" style="width:100px"> 
        			当前日期:<input name="datetransferFrom" class="easyui-datebox" style="width:100px"> 
        			是否启用:<input type="radio" name="isenable" value="1" checked="checked"/>是 
    ...
    <thead>   
        <tr>
      			...
      			<th data-options="field:'datetransferName',width:100" >节假日名称</th>  
      			<th data-options="field:'datetransferFrom',width:100" >当前日期</th>  
      			<th data-options="field:'datetransferTo',width:100" >上一次日期</th>  
...
<div id="dataDialog" class="easyui-dialog" title="信息" style="width:400px;height:200px;padding: 15px"   
    ...
    <table>
    	...
    	<tr><td>   
        <label for="datetransferName">节假日名称:</label>   
        </td><td>
			<input name="datetransferName" class="easyui-textbox" style="width:100px"> 
       </td></tr> 
    	
				
    	<tr><td>   
        <label for="datetransferFrom">当前日期:</label>   
        </td><td>
        	<input name="datetransferFrom" class="easyui-datebox" style="width:100px"> 
       </td></tr> 
    	
				
    	<tr><td>   
        <label for="datetransferTo">上一次日期:</label>   
        </td><td>
        	<input name="datetransferTo" class="easyui-datebox" style="width:100px"> 
       </td></tr> 
