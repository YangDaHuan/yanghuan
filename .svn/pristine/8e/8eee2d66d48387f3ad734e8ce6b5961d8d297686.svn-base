...
<form id="dataForm" >   
    ...
    <table>
    	...
    	<caption align="top" style="font-size:24px;color:#006600;">票卡调整入库单</caption> 
		<tr><td>&nbsp</td>   </tr><tr>
		<%-- <td>   
        <label for="inCode">调整单号:</label>
        </td><td>
			<input name="inCode" class="easyui-textbox" style="width:150px" value="${newTicketInCode }" data-options="required:true,readonly:true"> 
       </td> --%>
       <td align="right">
        <label for="inOrg">调整部门:</label>
        </td><td  colspan=1>
