...
function doSearch(){
	...
	$.post("ticket/findByAttrBizTicketStockHistory.zb",formdata,function(data){
			if(data.success){
...
function saveData(){
	...
	$.post("ticket/saveBizTicketStockHistory.zb",formdata,function(data){
			if(data.success){
...
function deleteRows(){
	...
	if(rows.length<1){
		...
		$.post("ticket/deleteBizTicketStockHistory.zb",obj,function(data){
			if(data.success){
...
<div id="dataTabelToolBar" style="height: auto">
			...
			<form id="queryForm">
					...
					:<input name="stockId" class="easyui-textbox" style="width:100px"> 
					:<input name="stockOrg" class="easyui-textbox" style="width:100px"> 
        			:<input name="stockDate" class="easyui-datebox" style="width:100px"> 
    ...
    <thead>   
        <tr>
      			...
      			<th data-options="field:'stockOrg',width:100" ></th>  
      			<th data-options="field:'stockDate',width:100" ></th>  
