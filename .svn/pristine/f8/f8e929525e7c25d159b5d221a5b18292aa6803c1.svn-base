...
<link rel="stylesheet" type="text/css"
	href="<%=appmap%>/raqsoft/easyui/themes/default/easyui.css">
<link rel="stylesheet" type="text/css"
	href="<%=appmap%>/raqsoft/easyui/themes/icon.css">
<script type="text/javascript"
	src="<%=appmap%>/raqsoft/easyui/jquery.min.js"></script>
<script type="text/javascript"
	src="<%=appmap%>/raqsoft/easyui/jquery.easyui.min.js"></script>
<script type="text/javascript"
	src="<%=appmap%>/raqsoft/easyui/locale/easyui-lang-zh_CN.js"></script>
		...
		%>
				<div data-options="region:'north',border:false">
					<center>
						<table id="param_tbl">
							<tr>
								<td><report:param name="form1" paramFileName="<%=argRpx%>"
										needSubmit="no" needImportEasyui="no" /></td>
				...
				<div id=reportContainer data-options="region:'center',border:false"
					...
					<raqsoft:input id="<%=sgid%>" src="<%=input%>" paramMode="i"
						excel="io" needImportEasyui="no" width="100%" height="100%"
						tabLocation="bottom" file="<%=dataFile%>" fileType="<%=fileType%>"
						outerDim="id" exceptionPage="myError.jsp" />
				</div>
			</div>
		</div>
		<%
