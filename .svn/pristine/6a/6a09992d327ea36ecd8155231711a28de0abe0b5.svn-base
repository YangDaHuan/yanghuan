...
function doSearch(){
	...
	$.post("ticket/findByAttrBizTicketStock.zb",formdata,function(data){
			if(data.success){
...
function saveData(){
	...
	$.post("ticket/saveBizTicketStock.zb",formdata,function(data){
			if(data.success){
...
function deleteRows(){
	...
	if(rows.length<1){
		...
		$.post("ticket/deleteBizTicketStock.zb",obj,function(data){
			if(data.success){
...
<div id="dataTabelToolBar" style="height: auto">
			...
			<form id="queryForm">
        			...
        			:<input name="stockUpdateDate" class="easyui-datebox" style="width:100px"> 
    ...
    <thead>   
        <tr>
      			...
      			<th data-options="field:'stockUpdateDate',width:100" ></th>  
...
<div id="dataDialog" class="easyui-dialog" title="信息" style="width:400px;height:200px;padding: 15px"   
    ...
    <table>
    	...
    	<tr><td>   
        <label for="stockUpdateDate">:</label>   
        </td><td>
        	<input name="stockUpdateDate" class="easyui-datebox" style="width:100px"> 
       </td></tr> 
