        ...
        $.contextMenu({
            ...
            ignoreRightClick: true,
             build: function($trigger, e) {
                ...
                var citems = {
                        "filter" : {name: "过滤", items: 
                         { 
                                "customfilter": {name: "自定义..." },
                                "clearfilter": {name: "清除过滤" }
                         }},
                        "limit" : {name: "界限", items: 
                        {
                                "TopCount###SEPARATOR###10": {name: "前10" },
                                "BottomCount###SEPARATOR###10": {name: "后10" },
                                "TopCountQuick" : { name: "前10 按照...", items: addFun(items, "TopCount") },
                                "BottomCountQuick" : { name: "后10 按照...", items: addFun(items, "BottomCount") },
                                "customtop" : {name: "自定义界限..." },
                                "clearlimit" : {name: "清除界限"}
                         }},
                        "sort" : {name: "排序", items:
                        {
                            "ASCQuick": {name: "升序" , items: addFun(items, "ASC") },
                            "DESCQuick": {name: "降序", items: addFun(items, "DESC")},
                            "BASCQuick": {name: "升序 (忽略层次)", items: addFun(items, "BASC")},
                            "BDESCQuick": {name: "降序 (忽略层次)", items: addFun(items, "BDESC") },
                            "customsort" : { name: "自定义..." },
                            "clearsort" : {name: "清除排序" }
                        }}
                };
