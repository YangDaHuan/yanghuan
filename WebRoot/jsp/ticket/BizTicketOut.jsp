...
function doSearch(){
	...
	$.post("ticket/findByAttrBizTicketOut.zb",formdata,function(data){
			if(data.success){
...
function saveData(){
	...
	$.post("ticket/saveBizTicketOut.zb",formdata,function(data){
			if(data.success){
	...
	if(rows.length<1){
		...
		var obj={};
				...
				for(var i=0;i<rows.length;i++){
					outId.push(rows[i].outId);
				}
				obj.outId=outId;
		
		
		
		$.post("ticket/deleteBizTicketOut.zb",obj,function(data){
			if(data.success){
...
<div id="dataTabelToolBar" style="height: auto">
			...
			<form id="queryForm">
					...
					:<input name="outId" class="easyui-textbox" style="width:100px"> 
					:<input name="deployId" class="easyui-textbox" style="width:100px"> 
					:<input name="outType" class="easyui-textbox" style="width:100px"> 
					:<input name="outOrg" class="easyui-textbox" style="width:100px"> 
					:<input name="toOrg" class="easyui-textbox" style="width:100px"> 
        			:<input name="outDate" class="easyui-datebox" style="width:100px"> 
    ...
    <thead>   
        <tr>
      			<th data-options="field:'outId',width:100,checkbox:true" ></th>
      			<th data-options="field:'deployId',width:100" ></th>  
      			<th data-options="field:'outType',width:100" ></th>  
      			<th data-options="field:'outOrg',width:100" ></th>  
      			<th data-options="field:'toOrg',width:100" ></th>  
      			<th data-options="field:'outDate',width:100" ></th>  
...
<div id="dataDialog" class="easyui-dialog" title="信息" style="width:400px;height:200px;padding: 15px"   
    ...
    <table>
    	<input type="hidden" name="outId" value=""/>
