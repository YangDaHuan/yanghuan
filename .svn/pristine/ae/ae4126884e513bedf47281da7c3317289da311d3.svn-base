		...
		<div data-options="region:'center',border:false">
			<div class="easyui-layout" data-options="fit:true">
				<div id=reportContainer data-options="region:'center',border:false"
					...
					<raqsoft:aggr id="<%=aggrId %>" src="<%=sht %>" mode="i"
						dataFiles="<%=dataFiles %>" fileType="json"
						exceptionPage="myError.jsp" theme="bootstrap"
						needImportEasyui="no" width="100%" height="100%"
						tabLocation="bottom" />
				</div>
			</div>
		</div>
