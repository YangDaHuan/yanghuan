	...
	%>
		<tr>
			<td align=center>
				<table id="param_tbl">
					<tr>
						<td><report:param name="form1" paramFileName="<%=paramFile%>"
								needSubmit="no" params="<%=param.toString()%>" /></td>
						<td><a href="javascript:_submit( form1 )"><img
								src="../raqsoft/images/query.jpg" border=no
		...
		<tr>
			<td align=center valign=top height=100%><report:html
					name="report1" reportFileName="<%=report%>" scrollWidth="950"
					needScroll="no" scrollHeight="350" funcBarLocation="top"
					scrollBorder="border:1px solid red" needPageMark="yes"
					generateParamForm="no" params="<%=param.toString()%>"
					exceptionPage="/reportJsp/myError2.jsp"
					appletJarName="raqsoftReportApplet.jar" /></td>
		</tr>
	</table>
