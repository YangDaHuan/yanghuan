...
<form id="dataForm" >   
    ...
    <table>
		...
		<caption align="top" style="font-size:24px;color:#006600;">票卡调整调整单</caption> 			
    	<tr><td>&nbsp</td>   </tr>
		<tr>
		<%-- <td>
        ...
        <label for="applyContacts">调整类型:</label>   
			...
			<select  id="outType" name="outType" style="width:150px;">
					 <option value="1" selected>调配调整</option>
  		 			 <option value="2">直接调整</option>
    		</select> 
       </td> -->
		<!-- <td >   
